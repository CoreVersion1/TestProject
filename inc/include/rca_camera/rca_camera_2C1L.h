#ifndef __RCA_CAMERA_2C1L_H__
#define __RCA_CAMERA_2C1L_H__
...
#if defined(RR_DRV_SW_CAMERA_EEPROM_V3)
#pragma pack(1)
typedef struct {
...
typedef struct {
    ...
    int temperature_compensate_info; // 温度补偿信息
    float laser_10cm_avg_width; // 立板 60 占空比平均线宽，产线使用 65 占空比
    float reserve[18];
} camera_reserve_ids0;
...
#define RCA_CAMERA_FRAME_START          RCA_CAMERA_FRAME_LINE
#define RCA_CAMERA_FRAME_END            RCA_CAMERA_FRAME_CLOSE
